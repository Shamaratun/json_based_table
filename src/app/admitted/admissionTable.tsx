...
import { Patient } from "../manage-patient/patient-profile/type";
                ...
                <tbody>
                    {
                        currentItems.map((p, i) => (
                            <tr key={i} className="hover:bg-gray-50" >
                                ...
                                {/* < td className="border px-4 py-2" > {admissionData?.hospital_name} </td> */}
                                ...
                                <td
                                   ...
                                   onClick={() => router.push(`manage-patient/patient-profile/${p.patient_id}`)}>
