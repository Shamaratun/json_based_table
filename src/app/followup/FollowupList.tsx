...
import { Patient } from "@/app/profileDesign/type";
import { useEffect, useState } from "react";
import { getTodaysFollowups } from "./getTodaysFollowups";
              ...
              <tbody className="bg-white divide-y divide-gray-100">
                {currentItems.map((p, i) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-md text-gray-700">{p.id}</td>
                    <td className="px-6 py-4 text-md text-gray-700">{p.name}</td>
