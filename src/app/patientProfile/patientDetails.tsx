...
//   if (!patient) return <p>Loading patient data...</p>; // Handle undefined
//  return (
//     <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
//       <PatientInfoRow label="Patient Name" className="text-bold" value={patient.name} />
...
//       <PatientInfoRow label="Hospital Name" value={patient.hospital_name} />
